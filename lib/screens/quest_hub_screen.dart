  ...
  Widget build(BuildContext context) {
    return Consumer<AppProvider>(
      builder: (context, app, _) {
        ...
        final scheduled = _isDaytime()
            ? app.getDailyTasksForToday()
            : app.getNightlyTasksForToday();
        ...
        final weeklyTasks = app.quests
            .where((q) => weekly(q) && !q.isCompleted)
            .toList();
        ...
        final name = app.currentUser!.username.trim();
        List<TaskModel> selected;
        switch (_filter) {
          case _QuestFilter.today:
            selected = today
                .where((q) => q.id != featured?.id && _isActionQuest(q))
                .toList();
            break;
          case _QuestFilter.weekly:
            selected = weeklyTasks;
            break;
              ...
              child: ConstrainedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    if (featured != null)
                      TaskCard(quest: featured, readingV2: true, featured: true)
                    else
                      ReadingSurface(
                        child: Column(
                    ...
                    ExpansionTile(
                      ...
                      subtitle: const Text('Optional quests and weekly goals'),
                      children: [
                        Align(
                          ...
                          child: Wrap(
                            ...
                            runSpacing: 8,
                            children: [
                              _filterChip(_QuestFilter.today, _todayLabel),
                              _filterChip(_QuestFilter.weekly, 'Weekly'),
                              _filterChip(
